...
### Existing samples.
 ...
 - [Custom Remote User Store Management](custom-remote-user-store-management/) by [Tharindu Bandara](https://github.com/tharindu-bandara) - An aggregator module to consume a remote user database as a secondary user store.
